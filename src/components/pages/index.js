...
export { Accueil, Login, Register, Profile, AccessDenied, Guide, Favorites, NewGuideHome, NewGuide, NewTravel, ProfileOtherUser, MyGuides, PlanMyTravel, OffresSpeciales };